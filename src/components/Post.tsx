  ...
  return (
    <div className="bg-white/70 p-8 rounded-lg shadow-md w-[45vw] h-[408px] w">
      ...
      <div className="block mt-2 relative">
        <form>
          <input
            className="block w-full p-3 px-4 overflow-hidden rounded-full border border-gray-300 pr-20"
            placeholder="Leave a comment"
          />
          <button
            type="submit"
            className="absolute right-2 top-1/2 transform -translate-y-1/2 pe-2 text-blue-600"
          >
            Post
          </button>
        </form>
